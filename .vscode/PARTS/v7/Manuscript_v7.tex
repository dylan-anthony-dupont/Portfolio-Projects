...
C_{\mathrm{up}}\ =\ C_{\rm tr}\cdot \frac{8\sqrt{8}}{\pi},\ \ \text{(Appendix~\ref{app:S1})} % [EDIT FINAL: S1 ptr]
\end{equation}
...
\begin{proof}
Let $\varphi_\pm:\D\to B$ be conformal with $\varphi_\pm(0)=v_\pm^\star$ (compose a disc automorphism with a fixed normalization if desired), and set $f:=W\circ\varphi_\pm$. % [EDIT FINAL: conformal φ]
