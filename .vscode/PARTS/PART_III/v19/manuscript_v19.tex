...
\end{equation}
\begin{proof}
By definition \(E(v)=\Lambda_2(1+v)\). Thus \(G(v)=\Lambda_2(2+v)/\Lambda_2(v)\).
...
The following numbers are \textbf{illustrative} and reproducible; full data/scripts available on request.
